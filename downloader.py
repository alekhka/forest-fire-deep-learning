# -*- coding: utf-8 -*-
"""
Created on Sat Apr 29 20:43:10 2017
...
class GoogleMapDownloader:
    ...
    def generateImage(self, **kwargs):
        ...
        tile_width = kwargs.get('tile_width', 20)
        ...
        for x in range(0, tile_width):
            for y in range(0, tile_height) :
                ...
                im.save(os.path.join('imgs6',"img"+str(z)+".png"))
...
def main():
    ...
    gmd = GoogleMapDownloader(0.9962, 24.9075, 15)
    ...
    try:
        ...
        img.save("high_resolution_image6.png")
